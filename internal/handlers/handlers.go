...
import (
	...
	"github.com/jordanryanoFA/bookings/internal/driver"
	"github.com/jordanryanoFA/bookings/internal/forms"
	...
	"github.com/jordanryanoFA/bookings/internal/repository/dbrepo"
)
...
func (m *Repository) Home(w http.ResponseWriter, r *http.Request) {
	render.Template(w, r, "home.go.tmpl", &models.TemplateData{})
}

// About is the handler for the about page
func (m *Repository) About(w http.ResponseWriter, r *http.Request) {
	// send data to the template
	render.Template(w, r, "about.go.tmpl", &models.TemplateData{})
}
...
func (m *Repository) Reservation(w http.ResponseWriter, r *http.Request) {
	...
	render.Template(w, r, "make-reservation.go.tmpl", &models.TemplateData{
		Form:      forms.New(nil),
		Data:      data,
		StringMap: stringMap,
	})
...
func (m *Repository) Generals(w http.ResponseWriter, r *http.Request) {
	render.Template(w, r, "generals.go.tmpl", &models.TemplateData{})
}

// Majors renders the room page
func (m *Repository) Majors(w http.ResponseWriter, r *http.Request) {
	render.Template(w, r, "majors.go.tmpl", &models.TemplateData{})
}

// Availability renders the search availability page
func (m *Repository) Availability(w http.ResponseWriter, r *http.Request) {
	render.Template(w, r, "search-availability.go.tmpl", &models.TemplateData{})
}
...
func (m *Repository) PostAvailability(w http.ResponseWriter, r *http.Request) {
	...
	render.Template(w, r, "choose-room.go.tmpl", &models.TemplateData{
		Data: data,
	})
}
...
func (m *Repository) Contact(w http.ResponseWriter, r *http.Request) {
	render.Template(w, r, "contact.go.tmpl", &models.TemplateData{})
}
...
func (m *Repository) ReservationSummary(w http.ResponseWriter, r *http.Request) {
	...
	render.Template(w, r, "reservation-summary.go.tmpl", &models.TemplateData{
		Data:      data,
		StringMap: stringMap,
	})
}
...
// BookRoom takes URL parameters, builds an sessional variable, and takes user to the make-reservation screen
...
func (m *Repository) ShowLogin(w http.ResponseWriter, r *http.Request) {
	render.Template(w, r, "login.go.tmpl", &models.TemplateData{
		Form: forms.New(nil),
	})
}

// handles the loggin user in
...
// mark a reservation as a processed
...
func (m *Repository) AdminPostReservationsCalendar(w http.ResponseWriter, r *http.Request) {
	...
	form := forms.New(r.PostForm)
	for _, x := range rooms {
		// get the block map from the session, loops through entire map, if we have an entry in the map
